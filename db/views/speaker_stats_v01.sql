SELECT COUNT(veracities.key), veracities.key, speaker_id FROM statements
...
WHERE assessments.evaluation_status = 'approved' AND statements.published = true AND statements.count_in_statistics = true
