  ...
  return (
    <div style={{ padding: '15px 0 40px 0' }}>
      ...
      <div style={{ marginTop: 15 }}>
        <SearchInput placeholder="Hledat dle názvu diskuze…" onChange={setSearch} value={search} />
      </div>

      <div style={{ marginTop: 15 }}>
        <Query<GetSourcesQuery, GetSourcesQueryVariables>
          query={GetSources}
          variables={{ name: search, offset: 0, limit: 50 }}
        >
          {(props) => {
            if (props.loading) {
              return <Loading />;
            ...
            if (search !== '' && props.data.sources.length === 0) {
              return <p>Nenašli jsme žádnou diskuzi s názvem „{search}“.</p>;
            }
