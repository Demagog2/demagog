            ...
            if (statement.assessment.veracity.key == 'true') {
              return (
                <div className={'d-flex align-items-center mb-2'} >
                  ...
                  <span className={'fs-6 text-uppercase fs-600 text-primary'}>Pravda</span>
                </div>
              );
            }
            if (statement.assessment.veracity.key == 'untrue') {
              return (
                <div className={'d-flex align-items-center mb-2'} >
                  ...
                  <span className={'fs-6 text-uppercase fs-600 text-red'}>Nepravda</span>
                </div>
              );
            }
            if (statement.assessment.veracity.key == 'misleading') {
              return (
                <div className={'d-flex align-items-center mb-2'} >
                  ...
                  <span className={'fs-6 text-uppercase fs-600 text-secondary'}>Zavádějící</span>
                </div>
              );
            }
            if (statement.assessment.veracity.key == 'unverifiable') {
              return (
                <div className={'d-flex align-items-center mb-2'}>
                  <span
                    className={
                      'w-25px h-25px d-flex align-items-center justify-content-center bg-gray rounded-circle me-2'
                    }
                  >
                    <svg
                      width="12"
                  ...
                  <span className={'fs-6 text-uppercase fs-600 text-gray'}>Neověřitelné</span>
                </div>
              );
            }
          })()}
