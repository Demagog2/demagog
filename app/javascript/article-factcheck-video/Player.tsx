    ...
    return (
      ...
      >
        <HeaderBar>
          <a
            href="/"
            className={"ms-2 d-flex aling-items-center"}
          >
          <svg width="40" height="40" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.3257 4.75202C14.8196 2.44077 12.1325 0.894531 9.05665 0.894531C4.33283 0.894531 0.506348 4.52252 0.506348 9.00128C0.506348 13.48 4.33283 17.108 9.05665 17.108C12.1252 17.108 14.8098 15.5687 16.3184 13.2668L8.25957 9.03373L16.3257 4.75202Z" fill="#111827"/>
          </svg>
        ...
        <VeracityContainer>
          {
              (() => {
                if (statement.assessment.veracity.key == "true") {
                  return  (
                    <div className={"d-flex align-items-center mb-2"}>
                      <span className={"w-25px h-25px d-flex align-items-center justify-content-center bg-primary rounded-circle me-2"}>
                        <svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M0.0507812 6.4745L1.38245 5.10858L6.00525 9.6629L15.5667 0.135742L16.9326 1.50166L6.00525 12.3947L0.0507812 6.4745Z" fill="white"></path>
                        </svg>
                      </span>
                ...
                if (statement.assessment.veracity.key == "untrue") {
                  return  (
                    <div className={"d-flex align-items-center mb-2"}>
                        <span className={"w-25px h-25px d-flex align-items-center justify-content-center bg-red rounded-circle me-2"}>
                          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.8642 1.58955L11.4983 0.223633L6.80319 4.90351L2.1081 0.223633L0.742188 1.58955L5.43348 6.26562L0.742188 10.9417L2.1081 12.3076L6.80319 7.62773L11.4983 12.3076L12.8642 10.9417L8.17291 6.26562L12.8642 1.58955Z" fill="white"></path>
                          </svg>
                        </span>
                ...
                if (statement.assessment.veracity.key == "unverifiable") {
                  return  (
                    <div className={"d-flex align-items-center mb-2"}>
                        <span className={"w-25px h-25px d-flex align-items-center justify-content-center bg-gray rounded-circle me-2"}>
